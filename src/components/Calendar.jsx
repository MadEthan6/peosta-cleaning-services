        ...
        <div className="card">
          ...
          <div className="flex align-center justify-between" style={{ marginBottom: 16 }}>
            ...
            <div className="flex gap-2">
              <button aria-label="Previous month" title="Previous month" onClick={prevMonth} className="btn btn-secondary" style={{ padding: 6, borderRadius: '8px' }}><ChevronLeft size={18} /></button>
              <button aria-label="Next month" title="Next month" onClick={nextMonth} className="btn btn-secondary" style={{ padding: 6, borderRadius: '8px' }}><ChevronRight size={18} /></button>
            </div>
          </div>
