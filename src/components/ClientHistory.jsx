          ...
          {selected ? (
            <div className="card dashboard-card" style={{ position: 'sticky', top: 20 }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 20 }}>
                ...
                <button onClick={() => setSelected(null)} aria-label="Close details" title="Close details" style={{ background: 'none', border: 'none', color: '#64748b', cursor: 'pointer', fontSize: '1.2rem' }}>✕</button>
              </div>
